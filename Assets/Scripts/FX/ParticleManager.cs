...
public class ParticleManager : MonoBehaviour
{
    ...
    private static ParticleSystem CreateHitSpark()
    {
        ...
        var emission = ps.emission;
        emission.SetBursts(new ParticleSystem.Burst[] { new ParticleSystem.Burst(0f, 8, 12) });
    ...
    private static ParticleSystem CreateFeatherBurst()
    {
        ...
        var emission = ps.emission;
        emission.SetBursts(new ParticleSystem.Burst[] { new ParticleSystem.Burst(0f, 8, 16) });
        emission.rateOverTime = 0f;
